...
const productSchema = new mongoose.Schema({
    ...
    detailIntro: { type: String, maxlength: 220, default: '' },
    detailBody: { type: String, maxlength: 2000, default: '' },
    highlights: [{ type: String, maxlength: 120 }],
    detailPoints: [{ type: String, maxlength: 180 }],
    images: [{ type: String }],
